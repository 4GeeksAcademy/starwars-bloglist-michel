...
export const SingleShip = (props) => {
	...
	const shipImages = store.shipsImages
    return(
        <div className="container-fluid">
            <div className="row my-3">
                <h2>Ships<span className="text-dark"> / {ships[id]?.name}</span></h2>
            </div>
            <div className="row bg-secondary m-5 border border-secondary single-card">
                <div className="row">
                    ...
                    <div className="col-8 p-4 ">
                        ...
                        <p className="single-info-text my-0"><b>Max Atmos:&nbsp;&nbsp;</b>{ships[id]?.max_atmosphering_speed}</p>
